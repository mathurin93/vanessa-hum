...
/* =========================================================
   IMAGE HELPER
   Uses Vite's BASE_URL so images work locally and on
   GitHub Pages at /vanessa-hum/
========================================================= */
...
const services = [
  {
    ...
    description:
      'Window artwork that combines visual storytelling with bird conservation.',
  },
  {
    number: '02',
    title: 'Chalkboards & Signage',
    description:
      'Hand-lettered menus, storefront features and custom signs.',
  },
  {
    number: '03',
        ...
        <section className="hero section">
          ...
          <div className="container hero-grid">
            ...
            <div className="hero-copy reveal">
              ...
              <p className="eyebrow">
                Artist · Researcher · Conservationist
              </p>
              ...
              <p className="hero-text">
                Vanessa creates hand-lettered
                artwork and bird-friendly
                murals that transform everyday
                spaces through creativity,
          ...
          <div className="container about-grid">
            ...
            <div className="about-collage">
              ...
              <figure className="about-image about-image--small">
                ...
                <img
                  src={imageUrl(
                    'university main picture.jpeg'
                  )}
                  alt="Bird-friendly public artwork"
                  loading="lazy"
                />
            ...
            <div className="about-copy">
              ...
              <p>
                ...
                Vanessa began with
                calligraphy, signage and
                illustration before
                expanding her practice to
                artwork on glass and
              ...
              <p>
                ...
                murals led to graduate
                research at Simon Fraser
                University studying
                bird-window collisions.
                Today, her work brings
                together art, science and
        ...
        <section className="conservation-section">
          ...
          <div className="container conservation-grid">
            ...
            <div className="conservation-copy">
              ...
              <p>
                Vanessa uses public art
                to make bird conservation
                more visible, approachable
                and connected to the
                spaces people use every
                day.
              </p>
            ...
            >
              ...
              <label>
                ...
                >
                  ...
                  <option>
                    Bird-friendly window mural
                  </option>

                  <option>
                    Chalkboard or signage
                  </option>
